...
Counts: **20 live** — 10 (Module B) + 7 (Module A) + 2 (Adjacent) + 1 (Platform) · **6 designed** (Module A, plus A4's materials half) · **6 designed** (the Gita) · the rest below.
...
| **A10** | One-click late-payer reminders | Designed | Replaces manual per-team texting; fires off payment status through the comms layer. | A9, comms | PRD A10 |
| **A11** | Google Drive import (on-ramp) | Designed | One-directional, onboarding only: ingest roster and prior-year Gita. Kills the "we already have it in Sheets" objection. Drive is never the backend. | — | PRD A11 |

---

## Phase 03 — v1 · Platform · **P1 live · P2–P3 designed**
