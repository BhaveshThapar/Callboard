...
**Status: designed, not implemented.** No Stripe code exists in this repo. This document is the spec Module A builds against, and the argument a treasurer has to be able to check.
