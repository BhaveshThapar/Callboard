...
/**
 * The tick. Vercel Cron calls this; nothing else should be able to.
 *
 ...
 *
 * Authorization is a shared secret in a header rather than an IP allowlist, because Vercel does not
 * promise stable egress addresses. Without `CRON_SECRET` set the route refuses everything: an
